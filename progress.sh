...
echo ""
echo "Hello, time is rolling. Today is $Y-$m-$d"
echo ---
echo "Today $padding  $(progress $d_progress)  ($(round $d_progress)%)" # | $bitbar"
# echo "$(progress $d_progress)                   " # | $bitbar"
echo ---
# month + progress bar
# echo "$Y-$m    $padding $(round $m_progress)%   | $bitbar"
echo "Month $padding  $(progress $m_progress)  ($(round $m_progress)%)" # | $bitbar"
# echo "$(progress $m_progress)                   " # | $bitbar"
echo ---
# year + progress bar
# echo "$Y       $padding $(round $Y_progress)%   | $bitbar"
echo "Year  $padding  $(progress $Y_progress)  ($(round $Y_progress)%)" # | $bitbar"
